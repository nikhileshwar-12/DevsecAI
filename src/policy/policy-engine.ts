...
export class PolicyEngine {
  private static policies: RepositoryGuideline[] = [
    {
      id: 'pol-sec-01',
      category: 'security',
  ...
  public static getPolicies(): RepositoryGuideline[] {
    return [...this.policies];
  }

  public static getActivePolicies(): RepositoryGuideline[] {
    return this.policies.filter(p => p.enabled);
  }

  public static addPolicy(policy: Omit<RepositoryGuideline, 'id'>): RepositoryGuideline {
    const newPolicy: RepositoryGuideline = {
      ...policy,
  ...
  public static togglePolicy(id: string): boolean {
  ...
  public static deletePolicy(id: string): boolean {
