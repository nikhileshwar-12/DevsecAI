import { ReviewFinding, BlastRadiusAnalysis, BlastRadiusNode, BlastRadiusEdge } from '../types/index.js';
...
export class BlastRadiusAnalyzer {
  public static analyze(findings: ReviewFinding[]): BlastRadiusAnalysis {
